<section id="banner" class="mx-auto relative">
  <div class="relative bg-primary text-white pt-40 pb-20">
    <div class="container max-w-6xl px-5 mx-auto relative z-40">
      <h1 class="relative text-6xl font-bold mb-5 uppercase z-10"><?php echo get_field("top_title"); ?></h1>
     	<p class="text-2xl font-light mb-20"><?php echo get_field("top_description") ?></p>
      <a href="#books" class="inline-block bg-secondary px-10 py-5 text-2xl font-bold">Book Now</a>
    </div>
...
<section id="books" class="mx-auto pt-20 pb-20 relative bg-white overflow-hidden">
    <div class="gap-8 relative"
      data-flickity='{ "pageDots": true, "initialIndex": 1 }'
      style="outline: none;" 
    >
      <!-- "cellAlign": "left"  -->
...
<section id="advantages" class="bg-primary relative bg-no-repeat bg-cover data-background-advantage">
  <img class="hidden md:block absolute h-full" src="<?php echo get_template_directory_uri() ?>/assets/img/angled-shape-overlay.svg">
  <div class="relative container pt-20 pb-20 max-w-6xl px-5 mx-auto z-10">
    <h2 class="relative text-3xl text-white font-bold mb-8 z-10"><?php echo get_field("our_advantages")["title"] ?></h2>
   	<p class="text-white mb-5 text-lg font-light max-w-xl">Whether you're travelling alone or with your family, on a business trip or a holiday, we'll make sure you and your loved ones are well-looked after. We are at your side to create an end-to-end airport experience that is secure, seamless and efficient for you and your loved ones.</p>
    <a href="" class="inline-block text-white bg-secondary text-lg px-10 py-4 font-bold mb-5">Watch how we do it</a>
    <div class="block md:flex mt-10 gap-8">
...
<section id="about" class="mx-auto relative">
  <div class="relative bg-primary text-white pt-20 pb-20">
    <div class="container max-w-6xl mx-auto">
      ...
      <h2 class="relative text-3xl text-white font-bold mb-8 z-10"><?php echo get_field("our_story")["title"] ?></h2>
      
      <p class="text-lg font-light mb-20 relative z-10 w-full md:w-2/5"><?php echo get_field("our_story")["description"] ?></p>
    </div>
...
?>
<section id="social" class="container max-w-6xl mx-auto mt-20 mb-20">
